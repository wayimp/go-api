...
async function routes (fastify, options) {
  ...
  fastify.post('/donation', async (req, res) => {
    ...
    const sessionToCreate = {
      ...
      mode: 'payment',
      success_url: orderId
        ? `https://gothereforeministries.org/order/${orderId}?sc=dr`
        : 'https://gothereforeministries.org',
      cancel_url: orderId
        ? `https://gothereforeministries.org/order/${orderId}`
        : 'https://gothereforeministries.org'
    }
  ...
  fastify.post('/subscriptions', { schema: updateOneSub }, async function (
    ...
    try {
      const session = await stripe.checkout.sessions.create({
        ...
        success_url: 'https://gothereforeministries.org',
        cancel_url: 'https://gothereforeministries.org'
      })
